...
import com.example.cmpmemecreator.meme_editor.presentation.MemeText
import com.example.cmpmemecreator.meme_editor.presentation.utils.MemeRenderCalculator
...
import com.example.cmpmemecreator.meme_editor.presentation.utils.ScaledMemeText
import com.example.cmpmemecreator.shared.R
...
actual class PlatformMemeExporter(
    ...
    private fun drawText(canvas: Canvas, memeText: ScaledMemeText) {
        ...
        val textWidth = (0 until strokeLayout.lineCount)
            .maxOfOrNull { strokeLayout.getLineWidth(it) } ?: 0f
